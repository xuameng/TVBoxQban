...
public final class MimeTypes {
  ...
  public static final String VIDEO_VP8 = BASE_TYPE_VIDEO + "/x-on2.vp8";
  public static final String VIDEO_VP9 = BASE_TYPE_VIDEO + "/x-on2.vp9";
  ...
  public static final String VIDEO_DOLBY_VISION = BASE_TYPE_VIDEO + "/dolby";
  ...
  public static final String AUDIO_DTS = BASE_TYPE_AUDIO + "/dts";
  public static final String AUDIO_DTS_HD = BASE_TYPE_AUDIO + "/dts.hd";
  public static final String AUDIO_DTS_EXPRESS = BASE_TYPE_AUDIO + "/dts.hd;profile=lbr";
  public static final String AUDIO_DTS_X = BASE_TYPE_AUDIO + "/dts.uhd;profile=p2";
  ...
  public static final String AUDIO_EXOPLAYER_MIDI = BASE_TYPE_AUDIO + "/x-midi";
  ...
  public static final String TEXT_EXOPLAYER_CUES = BASE_TYPE_TEXT + "/x-cues";
  ...
  public static final String APPLICATION_TX3G = BASE_TYPE_APPLICATION + "/tx3g";
  ...
  public static final String APPLICATION_AIT = BASE_TYPE_APPLICATION + "/dvb.ait";
