...
//		simSeekPosition = 0;      //XUAMENG重要
    ...
    public void tvSlideStart(int dir) {
		...
		if (mPositionUp == 0){
		   mPositionUp = 1;
		   int PositionXu1 = (int) mControlWrapper.getCurrentPosition();
		}
        PositionXu1 = (int) (simSlideOffset + PositionXu1);
        if (PositionXu1 > duration) PositionXu1 = duration;
        if (PositionXu1 < 0) PositionXu1 = 0;
		if (mPositionUp == 1){
		   updateSeekUI(currentPosition, PositionXu1, duration);
		}
