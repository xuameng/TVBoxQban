...
public class ModelSettingFragment extends BaseLazyFragment {
    ...
    protected void init() {
        ...
        tvScale.setText(PlayerHelper.getScaleName(Hawk.get(HawkConfig.PLAY_SCALE, 3)));		//XUAMENG默认缩放比例填充
        ...
        findViewById(R.id.llScale).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FastClickCheckUtil.check(v);
                int defaultPos = Hawk.get(HawkConfig.PLAY_SCALE, 3);       //XUAMENG默认缩放比例填充
