...
public class TransferActivity extends BaseActivity {
    ...
    private void addFileRow(final File file) {
        ...
        Button delete = new Button(this); delete.setId(View.generateViewId()); setTextSizeMM(delete, R.dimen.s_22); delete.setTextColor(0xffffffff); delete.setMinHeight(0); delete.setBackgroundResource(R.drawable.button_dialog_main); delete.setFocusable(true); delete.setContentDescription("删除 " + file.getName());
