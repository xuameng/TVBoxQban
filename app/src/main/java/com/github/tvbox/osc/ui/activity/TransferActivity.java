...
delete.setText("删除");
setTextSizeMM(delete, R.dimen.ts_22);
delete.setTextColor(0xffffffff);
delete.setBackgroundResource(R.drawable.button_dialog_main);
delete.setGravity(Gravity.CENTER);
delete.setFocusable(true);
delete.setClickable(true);
delete.setPadding(8, 5, 8, 5);
delete.setContentDescription("删除 " + file.getName());
